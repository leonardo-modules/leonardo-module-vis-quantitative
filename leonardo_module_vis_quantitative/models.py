...
#    data = YAMLField(verbose_name=_("data"), help_text=_('For graphite set: host, port, ssl, user, passwd'))
    ...
    class Meta:
        verbose_name = _("Quatitative data source")
        verbose_name_plural = _("Quatitative data sources")

class QuantitativeGraph(models.Model):
...
#    data = YAMLField(verbose_name=_("data"), help_text=_('For graphite set: host, port, ssl, user, passwd'))
    ...
    class Meta:
        verbose_name = _("Quatitative graph")
        verbose_name_plural = _("Quatitative graph")
...
class TimeSeriesWidget(Widget):
    ...
    """
    graph = models.ForeignKey(QuantitativeGraph, verbose_name=_('graph'), blank=True, null=True)
